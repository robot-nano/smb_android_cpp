...
import static com.example.smb.base.DocumentIdHelper.toDocumentId;
import static com.example.smb.base.DocumentIdHelper.toRootId;
import static com.example.smb.base.DocumentIdHelper.toUri;
import static com.example.smb.base.DocumentIdHelper.toUriString;
...
import com.example.smb.ShareManager.MountedShareChangeListener;
import com.example.smb.TaskManager;
import com.example.smb.auth.AuthActivity;
import com.example.smb.base.AuthFailedException;
import com.example.smb.base.DirectoryEntry;
import com.example.smb.base.DocumentCursor;
import com.example.smb.browsing.NetworkBrowser;
import com.example.smb.cache.CacheResult;
import com.example.smb.cache.DocumentCache;
import com.example.smb.document.DocumentMetadata;
import com.example.smb.document.LoadChildrenTask;
import com.example.smb.base.OnTaskFinishedCallback;
import com.example.smb.document.LoadDocumentTask;
import com.example.smb.document.LoadStatTask;
...
public class SambaDocumentsProvider extends DocumentsProvider {
  ...
  public static final String AUTHORITY = "com.example.smb";
