...
#define CLASS_PREFIX "com/example/smb"
...
extern "C" {
jlong Java_com_example_smb_nativefacade_NativeSambaFacade_nativeInit(
    JNIEnv *env, jobject thiz, jboolean debug, jlong cachePointer) {
...
void Java_com_example_smb_nativefacade_NativeSambaFacade_nativeDestroy(
...
jint Java_com_example_smb_nativefacade_NativeSambaFacade_openDir(
    JNIEnv *env, jobject thiz, jlong pointer, jstring uri_) {
...
void Java_com_example_smb_nativefacade_NativeSambaFacade_createFile(
    JNIEnv *env, jobject thiz, jlong pointer, jstring uri_) {
  const char *uri = env->GetStringUTFChars(uri_, 0);
  if (uri == NULL) {
    return;
...
Java_com_example_smb_nativefacade_NativeSambaFacade_rename(
    JNIEnv *env, jobject thiz, jlong pointer, jstring uri_, jstring nuri_) {
  const char *uri = env->GetStringUTFChars(uri_, 0);
  if (uri == NULL) {
    return;
  }
...
jint Java_com_example_smb_nativefacade_NativeSambaFacade_openFile(
        JNIEnv *env, jobject thiz, jlong pointer, jstring uri_, jstring mode_) {
  int fd = -1;
...
jobject Java_com_example_smb_nativefacade_SambaDir_readDir(
    JNIEnv *env, jobject thiz, jlong pointer, jint dh) {
  SambaClient::SambaClient *client =
      reinterpret_cast<SambaClient::SambaClient*>(pointer);
...
void Java_com_example_smb_nativefacade_SambaDir_close(
    JNIEnv *env, jobject thiz, jlong pointer, jint dh) {
  SambaClient::SambaClient *client =
      reinterpret_cast<SambaClient::SambaClient*>(pointer);
...
jobject Java_com_example_smb_nativefacade_SambaFile_fstat(
    JNIEnv *env, jobject thiz, jlong pointer, jint fd) {
  SambaClient::SambaClient *client =
      reinterpret_cast<SambaClient::SambaClient*>(pointer);
...
jlong Java_com_example_smb_nativefacade_SambaFile_seek(
    JNIEnv *env, jobject thiz, jlong pointer, jint fd, jlong offset, jint whence) {
  SambaClient::SambaClient *client =
      reinterpret_cast<SambaClient::SambaClient*>(pointer);
...
jint Java_com_example_smb_nativefacade_SambaFile_read(
    JNIEnv *env, jobject thiz, jlong pointer, jint fd,
    jobject buffer_, jint maxlen) {
...
jint Java_com_example_smb_nativefacade_SambaFile_write(
    JNIEnv *env, jobject thiz, jlong pointer, jint fd,
    jobject buffer_, jint length) {
  void *buffer = env->GetDirectBufferAddress(buffer_);
...
void Java_com_example_smb_nativefacade_SambaFile_close(
    JNIEnv *env, jobject thiz, jlong pointer, jint fd) {
  SambaClient::SambaClient *client =
      reinterpret_cast<SambaClient::SambaClient*>(pointer);
...
jlong Java_com_example_smb_nativefacade_NativeCredentialCache_nativeInit(
    JNIEnv *env, jobject thiz) {
  return reinterpret_cast<jlong>(new SambaClient::CredentialCache());
}

void Java_com_example_smb_nativefacade_NativeCredentialCache_putCredential(
        JNIEnv *env, jobject thiz, jlong pointer,
...
void Java_com_example_smb_SambaConfiguration_setEnv(
    JNIEnv *env, jobject thiz, jstring var_, jstring value_) {
